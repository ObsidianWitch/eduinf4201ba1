...
% \noindent Les outils suivants ont été utiles lors de la réalisation de ce TP :
% \begin{itemize}
%     \item \textbf{netstat} - % TODO description
%     \item \textbf{valgrind} - % TODO description
% \end{itemize}

\subsection{Instructions de compilation}
Ci-dessous les instructions pour compiler l'ensemble des exercices. L'utilitaire cmake est nécessaire afin de créer le Makefile. % TODO lien vers cmake
