...
\bibitem{cite:man_gethostbyname} \emph{Linux Programmer's Manual - GETHOSTBYNAME(3)}, \href{http://man7.org/linux/man-pages/man3/gethostbyname.3.html}{http://man7.org/linux/man-pages /man3/gethostbyname.3.html}

\bibitem{cite:msdn_hostent} \emph{hostent structure}, msdn, \href{http://msdn.microsoft.com/en-us/library/windows/desktop/ms738552%28v=vs.85%29.aspx}{http://msdn.microsoft.com/en-us/library/windows/desktop/ms738552 \%28v=vs.85\%29.aspx}
...
\bibitem{cite:http_easy} \emph{HTTP Made Really Easy}, \href{http://www.jmarshall.com/easy/http/}{http://www.jmarshall.com/easy/http/}
