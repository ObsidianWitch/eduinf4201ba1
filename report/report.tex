...
\begin{thebibliography}{5} % TODO
	% \bibitem{bib:netkitwiki} \emph{Netkit Wiki}, \href{http://wiki.netkit.org/index.php/Main_Page}{http://wiki.netkit.org/index.php/Main\_Page}tual-laboratories-with\_19.html}
\end{thebibliography}
